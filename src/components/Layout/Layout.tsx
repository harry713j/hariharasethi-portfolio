  ...
  return (
    <div className="xl:pt-[3.75rem] md:pt-[2.75rem] pt-[2.5rem]">
      <main className="relative xl:px-[6.5rem] xl:py-4 md:px-[4rem] md:py-3 sm:px-[2.7rem] px-[2.25rem] py-2">
        <Navbar />
        <section id="home" className="mb-8 mt-8 text-white">
        ...
        <section id="about" className="mb-8 text-highlight">
          Contrary to popular belief, Lorem Ipsum is not simply random text. It
          has roots in a piece of classical Latin literature from 45 BC, making
          it over 2000 years old. Richard McClintock, a Latin professor at
          Hampden-Sydney College in Virginia, looked up one of the more obscure
        ...
        <section id="skills" className="mb-8 text-electron">
          ...
          currently visible section, you can implement scroll event handling in
          React. When the user scrolls through the page, we'll detect which
