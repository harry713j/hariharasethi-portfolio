      ...
      >
        ...
        <g id="SVGRepo_iconCarrier" fill="none">
          <path
            ...
            className="animate-vader-animation"
          ...
          <g fill="none">
            <path
              ...
              strokeDashoffset="1000"
              className="animate-vader-animation"
              d="m30.57 41.13c.28-.1.79-.06.84.1s.41 8.41.17 8.63-.88.14-.88 0-.25-8.69-.13-8.73z"
            ></path>
            <path
              stroke="#ff0000"
              strokeWidth="0.5"
              ...
              strokeDashoffset="1000"
              className="animate-vader-animation"
              d="m28.74 41.26c.21-.09.7-.19.79 0s.55 8.61.38 8.66-.87.18-.87 0-.3-8.66-.3-8.66z"
            ></path>
            <path
              stroke="#ff0000"
              strokeWidth="0.5"
              ...
              strokeDashoffset="1000"
              className="animate-vader-animation"
              d="m27 44.8c.06-.14.87-.4.87-.23a52.12 52.12 0 0 1 .21 5.25 3 3 0 0 1 -.79.06s-.38-4.88-.29-5.08z"
            ></path>
            <path
              stroke="#ff0000"
              strokeWidth="0.5"
              ...
              strokeDashoffset="1000"
              className="animate-vader-animation"
              d="m25.25 46.8c0-.17.57-.64.65-.51a14 14 0 0 1 .26 3.45 4 4 0 0 1 -.79.14s-.16-2.88-.12-3.08z"
            ></path>
            <path
              stroke="#ff0000"
              strokeWidth="0.5"
              ...
              strokeDashoffset="1000"
              className="animate-vader-animation"
              d="m41.23 35.62c.19-.1 2.79-.16 4.58-.37a11 11 0 0 1 1.78-.25c.21 0 .48.87.36 1a17.41 17.41 0 0 1 -4.32.69c-1.46 0-2.29 0-2.29 0s-.48-.9-.11-1.07z"
            ></path>
            <path
              stroke="#ff0000"
              strokeWidth="0.5"
              ...
              strokeDashoffset="1000"
              className="animate-vader-animation"
              d="m42 38.39c.34-.09 1.41 1.51 1.41 1.51s-.19.79-.4.63a9.86 9.86 0 0 1 -1.5-1.63c-.08-.21.29-.46.49-.51z"
            ></path>
            <path
              stroke="#ff0000"
              strokeWidth="0.5"
              ...
              strokeDashoffset="1000"
              className="animate-vader-animation"
              d="m40.41 39.68c.29-.1 2.3 1.78 2.22 2s-.15.63-.28.59a19.84 19.84 0 0 1 -2.43-2.11c-.04-.22.37-.44.49-.48z"
            ></path>
            <path
              stroke="#ff0000"
              strokeWidth="0.5"
              ...
              strokeDashoffset="1000"
              className="animate-vader-animation"
              d="m39.41 41.16s2.55 2 2.47 2.32a2.36 2.36 0 0 1 -.36.67s-2.93-2.38-2.81-2.6.53-.26.7-.39z"
            ></path>
            <path
              stroke="#ff0000"
              strokeWidth="0.5"
              ...
              strokeDashoffset="1000"
              className="animate-vader-animation"
              d="m14.45 48.4c.2.07 2.81 2.31 2.82 2.72s-.11.63-.24.63a27 27 0 0 1 -2.93-2.38c-.05-.17.14-1.05.35-.97z"
            ></path>
            <path
              stroke="#ff0000"
              strokeWidth="0.5"
              ...
              strokeDashoffset="1000"
              className="animate-vader-animation"
              d="m13.67 50.5s3.83 3.16 3.83 3.37-.11.67-.23.67a35.1 35.1 0 0 1 -4.08-3.07c-.04-.25.48-.97.48-.97z"
            ></path>
            <path
              stroke="#ff0000"
              strokeWidth="0.5"
              ...
              strokeDashoffset="1000"
              className="animate-vader-animation"
              d="m16.27 17c-.17-.24.44-2.3 1.57-3.91s2.19-2.52 2.65-2.4.77.61.6.82a7.05 7.05 0 0 0 -2.72 2.86c-.79 1.85-.55 3-.8 3.06a1.86 1.86 0 0 1 -1.3-.43z"
            ></path>
            <path
              stroke="#ff0000"
              strokeWidth="0.5"
              ...
              strokeDashoffset="1000"
              className="animate-vader-animation"
              d="m44.85 13.23a2.79 2.79 0 0 1 1.6.54c.09.25.27.83-.11.76a10.8 10.8 0 0 1 -1.43-.53c-.17-.06-.31-.72-.06-.77z"
            ></path>
          </g>
        </g>
      </svg>
